            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
                ...
                <li>
                    <NavLink 
                        ...
                        className="nav-item" // Add class for hover effect
                    >
                ...
                <li className="sidebar-section-li">
                    <div className="sidebar-separator-small"></div> {/* Visual separator */}
                    <button 
                    ...
                    {contentOpen && (
                        <ul className="sub-menu">
                            ...
                            {/* Edit: Editor, Super Admin */}
                            {(user?.is_superuser || roles.includes('Editor') || roles.includes('Super Admin')) && (
                                <li><NavLink to="/dashboard/content/edit" style={({ isActive }) => ({ ...subDefaultStyle, ...(isActive ? { color: '#3498db', fontWeight: 'bold' } : {}) })}>Edit content</NavLink></li>
                            )}
                ...
                {/* Analytics Management Dropdown (Admin/Super Admin only) */}
                {(user?.is_superuser || roles.includes('Admin') || roles.includes('Super Admin')) && (
                    <li className="sidebar-section-li">
                ...
                {/* User Management Dropdown (Admin/Super Admin only) */}
                {isAdmin && (
                    <li className="sidebar-section-li">
                        <div className="sidebar-separator-small"></div>
                        <button 
